...
public class Offers extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*txtCustomer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(), SelectCustomerName.class);
				startActivity(i);
			}
		});*/
		...
		FatchProductBrandAsynTask fatchProductBrandAsynTask = new FatchProductBrandAsynTask(Offers.this);
		...
		btnPlaceOrder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//PlaceOrderAsynTask placeOrderAsynTask = new PlaceOrderAsynTask(Offers.this);
	...
	private class FatchLensAsynTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPostExecute(Void result) {
			...
			if(lensForInventories != null && lensForInventories.size() > 0){
				...
				ArrayAdapter<String> arrayAdapterLensCode = new ArrayAdapter<String>(Offers.this, R.layout.spinner_simple_item_1);
	...
	/*private class PlaceOrderAsynTask extends AsyncTask<Void, Void, Integer>{
		...
		protected Integer doInBackground(Void... params) {
			...
			try{
				...
				methodResponseOrderStockLens = webServiceObjectClient.orderStockLens(customerCode,custRefNo,lensCode,
