...
public class TrackOrderByCustRefNoAsynTask extends AsyncTask<Void, Void, Integer>{

	private static final String tag = "TrackOrderByCustRefNoAsynTask";
	...
	public TrackOrderByCustRefNoAsynTask(Context context, DrishtiApplication mApp,
	...
	protected Integer doInBackground(Void... params) {
		// TODO Auto-generated method stub
		try{
			methodResponseOrders = webServiceObjectClient.getOrderByCustomerRefNo(customerRefNo);
