...
import com.gkbhitech.drishti.order.SelectCustomerActivity.FatchCustomerAsynTask;
...
public class SelectCustomerName extends Activity{
	private static final String tag = "SelectCustomerName";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchCustomerAsynTask fatchCustomerAsynTask = new FatchCustomerAsynTask(SelectCustomerName.this);
	...
	public class FatchCustomerAsynTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				customers = dataBaseAdapter.getCustomerName(mApp.getPlant());
