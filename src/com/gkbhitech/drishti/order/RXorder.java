...
public class RXorder extends Activity {
	
	/*private static final String tag = "RXorder";
	private static final int user_id=254;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rx_order);
		...
		// final CentralClass AC = (CentralClass)getApplicationContext();
		
		
		/*Bundle b = getIntent().getExtras();		
		String shvcnashi = b.getString("username");
		String plant = b.getString("r_plant");*/
		
		/*LoginActivity la= new LoginActivity();
		String userName=la.getSessionName();*/
		...
		webView.loadUrl("http://121.242.11.72/lib/models/new_order_form.php?app=1&username=shashi&splant=2005&user_id=254"
);
	*/	
	...
	private Spinner spnLeSph,spnLeAdd, spnLeCyl, spnReSph, spnReAdd, spnReCyl,spnProductBrand, spnLensCode, spnReQty,spnLeQty;
	...
	private float sphLe, sphRe, sphLeAdd, sphReAdd;
	private float cylLe, cylRe, cylLeAdd, cylReAdd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchProductBrandAsynTask fatchProductBrandAsynTask = new FatchProductBrandAsynTask(RXorder.this);
		...
		ArrayAdapter<Double> arrayAdapterAdd = new ArrayAdapter<Double>(getApplicationContext(), R.layout.spinner_simple_item_1, Constant.cylZeroToMinusTwo);
		...
		spnLeAdd.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long arg3) {
				// TODO Auto-generated method stub
				cylLeAdd = Constant.cylZeroToMinusTwo[position].floatValue();
			}
		...
		spnReAdd.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long arg3) {
				// TODO Auto-generated method stub
				cylReAdd = Constant.cylZeroToMinusTwo[position].floatValue();
			}
		...
		btnPlaceOrder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				PlaceOrderAsynTask placeOrderAsynTask = new PlaceOrderAsynTask(RXorder.this);
	...
	private class FatchLensAsynTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPostExecute(Void result) {
			...
			if(lensForInventories != null && lensForInventories.size() > 0){
				...
				ArrayAdapter<String> arrayAdapterLensCode = new ArrayAdapter<String>(RXorder.this, R.layout.spinner_simple_item_1);
	...
	private class PlaceOrderAsynTask extends AsyncTask<Void, Void, Integer>{
		...
		protected void onPostExecute(Integer result) {
			...
			if(result == Constant.RESULT_SUCCESS){
				AlertDialog.Builder alertDialog = new AlertDialog.Builder(RXorder.this);
