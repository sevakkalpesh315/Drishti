...
public class SelectCustomerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchCustomerAsynTask fatchCustomerAsynTask = new FatchCustomerAsynTask(SelectCustomerActivity.this);
	...
	public class FatchCustomerAsynTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				customers = dataBaseAdapter.getCustomer(mApp.getUserType(), mApp.getUserName(), mApp.getPlant());
		...
		protected void onPostExecute(Void result) {
			...
			lvCustomer.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View view,
					...
					customer = dataBaseAdapter.getCustomerByCustCode(customer.getCust_code());
					mApp.setCustomer(customer);
					onBackPressed();
				}
			});
