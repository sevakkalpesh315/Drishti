...
public class SelectCustomerForActivatePPLPActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchCustomerAsynTask fatchCustomerAsynTask = new FatchCustomerAsynTask(SelectCustomerForActivatePPLPActivity.this);
	...
	public class FatchCustomerAsynTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				customers = dataBaseAdapter.getCustomerForActivatePPLP(mApp.getUserType(), mApp.getUserName(), mApp.getPlant());
