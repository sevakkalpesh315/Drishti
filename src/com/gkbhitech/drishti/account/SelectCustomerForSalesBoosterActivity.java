...
public class SelectCustomerForSalesBoosterActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchCustomerAsynTask fatchCustomerAsynTask = new FatchCustomerAsynTask(SelectCustomerForSalesBoosterActivity.this);
	...
	public class FatchCustomerAsynTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				customers = dataBaseAdapter.getCustomerForSalesBooster(mApp.getUserType(), mApp.getUserName(), mApp.getPlant());
