...
public class SalesBoosterActivity extends Activity {
	...
	private Spinner spnInhouseBank,spnPaymentMode;
	...
	private String customerCode,paymentMode,chequeNo,bankName,sap_gl;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sales_booster);
		...
		txtCustomer.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(getApplicationContext(), SelectCustomerForSalesBoosterActivity.class);
				startActivity(i);
			}
		});
		...
		txtChequeDate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(selectedChequeDate == null){
					dialog = new AlternativeDateSlider(SalesBoosterActivity.this, onChequeDateSetListener, new GregorianCalendar(), before, after);
				}else{
					dialog = new AlternativeDateSlider(SalesBoosterActivity.this, onChequeDateSetListener, selectedChequeDate, before, after);
				}
				dialog.show();
			}
		});
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				CustomerReceiptFormAsynTask customerReceiptFormAsynTask = new CustomerReceiptFormAsynTask(SalesBoosterActivity.this, mApp, dataBaseAdapter, Constant.URL_SALES_BOOSTER, customerReceipt);
	...
	private class FatchInhouseBankAsynTask extends AsyncTask<Void, Void, Void>{
		...
		protected void onPreExecute() {
			// TODO Auto-generated method stub
			super.onPreExecute();
			progressDialog = new ProgressDialog(SalesBoosterActivity.this);
		...
		protected void onPostExecute(Void result) {
			...
			if(inhouseBanks != null && inhouseBanks.size() > 0){
				...
				ArrayAdapter<String> arrayAdapterInhouseBank = new ArrayAdapter<String>(SalesBoosterActivity.this, R.layout.spinner_simple_item_1, inhouseBankDesc);
