...
public class SelectCustomerForCustomerBalanceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		FatchCustomerAsynTask fatchCustomerAsynTask = new FatchCustomerAsynTask(SelectCustomerForCustomerBalanceActivity.this);
	...
	public class FatchCustomerAsynTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				customers = dataBaseAdapter.getCustomerForBalance(mApp.getPlant());
