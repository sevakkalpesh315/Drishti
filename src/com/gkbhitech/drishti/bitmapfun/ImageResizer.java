...
public class ImageResizer extends ImageWorker {
	...
	private Bitmap processBitmap(int resId) {
		...
		return decodeSampledBitmapFromResource(mContext.getResources(), resId,
				mImageWidth, mImageHeight, mContext);
	}
	...
	public static Bitmap decodeSampledBitmapFromResource(Resources res,
			int resId, int reqWidth, int reqHeight, Context context) {
		// Convert pixels to dp

		reqWidth = (int) convertPixelsToDp(reqWidth, context);
		reqHeight = (int) convertPixelsToDp(reqHeight, context);
	...
	public static synchronized Bitmap decodeSampledBitmapFromFile(
			String filename, int reqWidth, int reqHeight, Context context) {
