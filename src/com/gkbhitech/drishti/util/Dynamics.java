...
package com.gkbhitech.drishti.util;
...
public abstract class Dynamics {
     ...
     */
	private static final String tag = "Dynamics";
    ...
    public void setMaxPosition(final float maxPosition) {
    	Log.i(tag, "mMaxPosition : "+maxPosition);
    ...
    public void setMinPosition(final float minPosition) {
    	Log.i(tag, "mMinPosition : "+minPosition);
    ...
    protected float getDistanceToLimit() {
        ...
        Log.i(tag, "mPosition : "+mPosition+" mMaxPosition : "+mMaxPosition+" mMinPosition : "+mMinPosition);
